...
set "M3_PRODUCTION_MODE=0"
set "CIB_ALLOW_SUBMIT="
set "BOC_ENABLE_ORDER_SUBMIT="
set "M3_CMB_USB_PORT=7"
set "M3_BANK_AMOUNT_OVERRIDE=0.01"
...
"%PYTHON_EXE%" "C:\Users\30112\Desktop\网关\scripts\run_and_report.py" --project-path "%CD%" --title "M3自动调度进程异常退出" --source "M3 auto_extract_dispatch" --cwd "%CD%" -- "%PYTHON_EXE%" "auto_extract_dispatch.py" --poll-seconds 60 --quiet-idle --notify-final
